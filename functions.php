...
function sp_footer_creds_text() {
	...
	echo 'Copyright &copy; ';
	echo date('Y');
	echo ' &middot; <a href="http://koko.com.ph">koko.com.ph</a> &middot; Powered by <a href="http://rightbrainerdesign.com">RightBrainer Designs</a>';
	echo '</p></div>';
}
...
while($q->have_posts()) : $q->the_post();
 ...
 $list .= '<li>' . '<a href="' . get_permalink() . '" class="recent-posts-title">' . get_the_title() . '</a>' . '<br />' .  get_the_date() . '<br />' . get_the_excerpt() . '<br />' . '<a href="' . get_permalink() . '" class="recent-posts-read-more">' . 'Read More' . '</a>'  . '</li>';
